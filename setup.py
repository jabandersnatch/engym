...
setup(name='engym',
      ...
      description='Engineering gym: A implemention that uses the latest and greates algorithms for solving engineering problems',
      author='OpenAI',
      url='https://github.com/jabandersnatch/engym',
      author_email='juanandresmendez859@gmail.com',
      version='0.1.5')
