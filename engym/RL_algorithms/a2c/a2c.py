...
from engym.RL_algorithms.ppo2.ppo2 import safemean
...
def learn(
    ...
    **network_kwargs):
    ...
    network:            policy network architecture. Either string (mlp, lstm, lnlstm, cnn_lstm, cnn, cnn_small, conv_only - see engym.common/models.py for full list)
                        ...
                        See engym.common/policies.py/lstm for more details on using recurrent nets in policies


    env:                RL environment. Should implement interface similar to VecEnv (engym.common/vec_env) or be wrapped with DummyVecEnv (engym.common/vec_env/dummy_vec_env.py)
