...
class BalancebotEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.botId = p.loadURDF(os.path.join(path, "robot_assembly.xml"),
                           cubeStartPos,
        ...
        return np.array([obs[0] + np.random.normal(0,0.05) + self.pitch_offset,
    ...
    def _compute_observation(self):
        ...
        obs = [cubeEuler[0],angular[0],self.vt]
